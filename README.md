...
> Atualmente, estou modularizando o codigo.
...
- Preciso encapsular as funcionalidades relevantes em procedimentos free e malloc.
  ...
  - criar uma pilha que armazena os endereço iniciais e finais(?) de alocação - teremos uma estrutura de dados que vai monitorar a alocação. Por enquanto, o mais simples seria permitir apenas a desalocação de endereços no topo. Além disso, por enquanto, a pilha terá tamanho fixo.
